-- Migration script to update features for production
...
UPDATE features SET 
  ...
  benefits = '{"Pre-configured bad words filter (26+ words)", "Automatic content deletion", "Smart spam & raid protection", "Customizable warning system", "Zero setup required"}'
WHERE id = 37;
...
UPDATE features SET 
  ...
  benefits = '{"Live Discord stat embeds", "Auto-updating every minute", "Server & member metrics", "Bot performance tracking", "Professional status displays"}'
WHERE id = 38;
...
UPDATE features SET 
  ...
  benefits = '{"Button-based reaction roles", "Automatic role assignment", "Permission templates", "Role hierarchy management", "20+ active reaction roles"}'
WHERE id = 39;
...
UPDATE features SET 
  ...
  benefits = '{"7 logging categories", "Professional Discord embeds", "Member activity tracking", "Comprehensive audit trails", "Auto-setup with /botlogs command"}'
WHERE id = 40;
...
UPDATE features SET 
  ...
  benefits = '{"67+ professional slash commands", "AI-powered assistance", "Admin & moderation tools", "Utility commands", "Server info & management"}'
WHERE id = 41;
...
UPDATE features SET 
  ...
  benefits = '{"Real-time web dashboard", "Discord server integration", "Bulk config import", "Live channel/role selection", "Professional admin interface"}'
WHERE id = 42;
