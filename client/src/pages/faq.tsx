...
const faqCategories: FAQCategory[] = [
  ...
  },
  {
    ...
    icon: Zap,
    description: "Using NexGuard's 61+ commands and advanced features",
    questions: [
      {
        question: "How many commands does NexGuard have?",
        answer: "NexGuard has 61+ commands across 8 major categories: Admin, Moderation, Utility, Ticket System, AutoMod, Auto-Reply, Event Logging, and Role Management. Use `/commands` to see the complete list organized by category with detailed descriptions and usage examples.",
