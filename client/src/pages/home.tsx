...
const Home = memo(function Home() {
  ...
  return (
    <>
      <SEOHead 
        title="Home"
        description="NexGuard - Professional Discord bot with advanced moderation, ticket system, analytics, and comprehensive server management. Protecting 639+ users across 17+ servers."
