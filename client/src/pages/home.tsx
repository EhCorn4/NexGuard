      ...
      <div className="container mx-auto px-4 text-center relative z-10 pt-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            The ultimate Discord moderation and quality-of-life bot with 50+ commands, professional ticket system, universal logging, and advanced automod protection. Keep your server safe, organized, and thriving with enterprise-grade automation.
          </p>
